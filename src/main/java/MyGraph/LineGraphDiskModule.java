...
public class LineGraphDiskModule extends JFrame {
	   
	   public LineGraphDiskModule( String applicationTitle , String chartTitle ) {
		      super(applicationTitle);
		      JFreeChart lineChart = ChartFactory.createLineChart(
		         chartTitle,
		         "Hour","Disk Write Speed",
		...
		public static DefaultCategoryDataset MysqlConnectionAction()
		{
		    ...
		    try {
		        ...
		        ResultSet resultSet = statement.executeQuery("select ddValue,ddTime from diskdata where ddDayID='"+ActionModule.getDayID()+"' and ddType=2;" );
...
/*		        int i=0;
	   ...
	   {
		   LineGraphDiskModule chart = new LineGraphDiskModule(
		    	         "Disk Write Speed vs Today's Hour" ,
		    	         "Disk Write Speed vs Hour");
